...
with schemdraw.Drawing(show=False, margin=-0.75) as d:
    ...
    data_trf = elm.EncircleBox([std, norm], padx=-.3, pady=.2).linestyle('-').linewidth(2).label('DATA\nTRANSFORMATION', ofst=(3.0, -3.3), rotate=270)
    data_trf.at((0, -14.5))
    ...
    feat_sel = elm.EncircleBox([correlat, pps], padx=.1, pady=0.0).linestyle('-').linewidth(2).label('FEATURE\nSELECTION', ofst=(2.9, -3.4), rotate=270)
    feat_sel.at((0, -18.5))
